...
articles = driver.find_elements(By.CSS_SELECTOR, "#center_column > ul")

#mongodb = MongoDriver()

for card in articles:
    try:
        title = card.find_element(By.CSS_SELECTOR, "div > div > div.center-block2.col-xs-4.col-xs-7.col-md-6 > h3").text
